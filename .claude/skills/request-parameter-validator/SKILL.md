---
name: "request-parameter-validator"
pack: "web-engineering-pack"
purpose: "Review query, path, header, cookie, and body parameters so valid, invalid, and missing cases are explicitly handled."
...
handoffs: ["server-side-validation-enforcer", "form-validation-designer", "route-and-controller-planner"]
---
# request-parameter-validator

## Purpose
Review query, path, header, cookie, and body parameters so valid, invalid, and missing cases are explicitly handled.
