---
name: "web-application-framework-selector"
pack: "web-engineering-pack"
purpose: "Select an appropriate web application framework or stack based on routing, rendering, forms, security, deployment, and team capability."
...
handoffs: ["route-and-controller-planner", "mvc-boundary-checker", "web-feature-iteration-planner"]
---
# web-application-framework-selector

## Purpose
Select an appropriate web application framework or stack based on routing, rendering, forms, security, deployment, and team capability.
