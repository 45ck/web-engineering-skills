---
name: "route-and-controller-planner"
pack: "web-engineering-pack"
purpose: "Plan routes, handlers, controllers, and action boundaries so the web surface is coherent, minimal, and testable."
...
handoffs: ["request-response-flow-mapper", "mvc-boundary-checker", "web-navigation-structure-reviewer"]
---
# route-and-controller-planner

## Purpose
Plan routes, handlers, controllers, and action boundaries so the web surface is coherent, minimal, and testable.
