---
name: "presentation-model-designer"
pack: "web-engineering-pack"
purpose: "Design the presentation model for a web feature including pages, components, dynamic states, validation messages, and navigation outcomes."
...
handoffs: ["template-rendering-reviewer", "web-navigation-structure-reviewer", "error-page-and-fallback-planner"]
---
