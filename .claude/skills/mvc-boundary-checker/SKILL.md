---
name: "mvc-boundary-checker"
pack: "web-engineering-pack"
purpose: "Check whether models, views, controllers, handlers, or route functions have clear responsibilities without leaking concerns across layers."
...
handoffs: ["route-and-controller-planner", "template-rendering-reviewer", "client-server-responsibility-splitter"]
---
# mvc-boundary-checker

## Purpose
Check whether models, views, controllers, handlers, or route functions have clear responsibilities without leaking concerns across layers.
