---
name: "web-feature-iteration-planner"
pack: "web-engineering-pack"
purpose: "Break a web feature into staged increments covering page shell, routing, data, validation, rendering, and hardening."
...
handoffs: ["request-response-flow-mapper", "route-and-controller-planner", "web-navigation-structure-reviewer"]
---
# web-feature-iteration-planner

## Purpose
Break a web feature into staged increments covering page shell, routing, data, validation, rendering, and hardening.
