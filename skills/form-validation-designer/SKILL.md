---
name: "form-validation-designer"
pack: "web-engineering-pack"
purpose: "Design input validation rules for forms including required fields, format checks, boundaries, error messaging, and invalid/missing cases."
...
handoffs: ["request-parameter-validator", "server-side-validation-enforcer", "error-page-and-fallback-planner"]
---
# form-validation-designer

## Purpose
Design input validation rules for forms including required fields, format checks, boundaries, error messaging, and invalid/missing cases.
