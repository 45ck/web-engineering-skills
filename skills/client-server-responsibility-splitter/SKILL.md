---
name: "client-server-responsibility-splitter"
pack: "web-engineering-pack"
purpose: "Decide which responsibilities belong on the client and which belong on the server including validation, orchestration, rendering, and persistence."
...
handoffs: ["mvc-boundary-checker", "session-state-strategy-reviewer", "progressive-enhancement-reviewer"]
---
# client-server-responsibility-splitter

## Purpose
Decide which responsibilities belong on the client and which belong on the server including validation, orchestration, rendering, and persistence.
