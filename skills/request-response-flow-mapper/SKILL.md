---
name: "request-response-flow-mapper"
pack: "web-engineering-pack"
purpose: "Map the request-response flow for a web feature including actors, routes, parameters, controllers, services, data stores, and rendered outputs."
...
handoffs: ["form-validation-designer", "route-and-controller-planner", "client-server-responsibility-splitter"]
---
# request-response-flow-mapper

## Purpose
Map the request-response flow for a web feature including actors, routes, parameters, controllers, services, data stores, and rendered outputs.
