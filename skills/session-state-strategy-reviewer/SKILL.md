---
name: "session-state-strategy-reviewer"
pack: "web-engineering-pack"
purpose: "Review how the application manages session state, identity, transient workflow data, and concurrency risks across requests."
...
handoffs: ["client-server-responsibility-splitter", "error-page-and-fallback-planner", "mvc-boundary-checker"]
---
# session-state-strategy-reviewer

## Purpose
Review how the application manages session state, identity, transient workflow data, and concurrency risks across requests.
