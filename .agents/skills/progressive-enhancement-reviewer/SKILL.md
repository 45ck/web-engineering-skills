---
name: "progressive-enhancement-reviewer"
pack: "web-engineering-pack"
purpose: "Review whether the feature still works with minimal JavaScript and whether richer behavior enhances rather than replaces baseline functionality."
...
handoffs: ["client-server-responsibility-splitter", "template-rendering-reviewer", "error-page-and-fallback-planner"]
---
# progressive-enhancement-reviewer

## Purpose
Review whether the feature still works with minimal JavaScript and whether richer behavior enhances rather than replaces baseline functionality.
