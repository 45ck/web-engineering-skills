---
name: "server-side-validation-enforcer"
pack: "web-engineering-pack"
purpose: "Enforce the rule that trust boundaries are on the server and validation cannot rely on client-side checks alone."
...
handoffs: ["request-parameter-validator", "error-page-and-fallback-planner", "session-state-strategy-reviewer"]
---
